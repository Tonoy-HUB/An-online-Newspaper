           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                        <a class="{{ Route::is('admin/role/*') ? 'active-menu' : '' }}" href="#"><i class="fa fa-user fa-3x"></i> User Role<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a href="/roles">
                                    <i class="fa fa-check"></i> Manage User Roles
                                </a>
                            </li>
                        </ul>
                      </li> 
                    ...
                    <li>
                        <a class="{{ Route::is('admin/*') ? 'active-menu' : '' }}" href="#"><i class="fa fa-users fa-3x"></i>User<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="/reporter/create">
                                    <i class="fa fa-plus"></i> Add User
                                </a>
                            </li>
                            <li>
                                <a href="/reporters">
                                    <i class="fa fa-check"></i> Manage User
                                </a>
                            </li>
                        </ul>
                      </li> 
...
<!--
                    ...
                    -->
                    <li>
                        <a class="{{ Route::is('admin/news/create') ? 'active-menu' : '' }}" href="#"><i class="fa fa-newspaper-o fa-3x"></i> News<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
