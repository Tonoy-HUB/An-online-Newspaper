    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/admin/home">User Panel</a> 
            </div>
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                      ...
                      <li>
                        <a class="{{ Route::is('admin') ? 'active-menu' : '' }}" href="/feedback"><i class="fa fa-sitemap fa-3x"></i> Feedback<span class="fa arrow"></span></a>
                      </li> 
